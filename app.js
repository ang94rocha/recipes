...
let testing = document.querySelector(".recipes");
...
function homepagePrint(string) {
  console.log(string)
}

const mappingRecipes = recipes.map(homepagePrint);

document.getElementById("mappingRecipes").innerHTML = 
